...
export default function MoonPhases({
  ...
  /*
    Ângulos das oito fases.
    A Lua percorre uma órbita em volta da Terra.
  */
      ...
      >
        ...
        >
          <defs>
            {/* =================================================
                RECORTE DA TERRA
                Impede os continentes de ultrapassarem
                o limite do círculo da Terra.
            ================================================= */}
